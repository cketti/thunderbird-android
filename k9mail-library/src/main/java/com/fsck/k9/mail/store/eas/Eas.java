...
public class Eas {
    ...
    public static final String EXCHANGE_ACCOUNT_MANAGER_TYPE = "com.android.exchange"; //FIXME
    public static final String PROTOCOL = "eas";
    public static final String EXCHANGE_SERVICE_INTENT_ACTION = "com.android.email.EXCHANGE_INTENT"; //FIXME
