...
import com.fsck.k9.mail.store.eas.SSLUtils.KeyChainKeyManager;
import com.fsck.k9.mail.store.eas.SSLUtils.TrackingKeyManager;
...
public class EmailClientConnectionManager extends ThreadSafeClientConnManager {
    ...
    public synchronized void registerClientCert(Context context, HostAuth hostAuth)
        ...
        if (existing == null) {
            if (LOG_ENABLED) {
                LogUtils.i(LogUtils.TAG, "Registering socket factory for certificate alias ["
