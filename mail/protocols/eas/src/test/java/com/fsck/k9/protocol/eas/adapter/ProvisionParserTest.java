...
public class ProvisionParserTest extends RobolectricTest {
    ...
    public void testWapProvisionParser1() throws IOException {
        ProvisionParser parser = new ProvisionParser(context, mTestInputStream);
        ...
        assertEquals(5*60, policy.maxScreenLockTime);  // Screen lock time is in seconds
        assertEquals(8, policy.passwordMinLength);
        assertEquals(Policy.PASSWORD_MODE_STRONG, policy.passwordMode);
        assertEquals(20, policy.passwordMaxFails);
    }
    ...
    public void testWapProvisionParser2() throws IOException {
        ...
        assertEquals(Policy.PASSWORD_MODE_NONE, policy.passwordMode);
    }
    ...
    public void testWapProvisionParser3() throws IOException {
        ...
        assertEquals(2*60, policy.maxScreenLockTime);  // Screen lock time is in seconds
        assertEquals(4, policy.passwordMinLength);
        assertEquals(Policy.PASSWORD_MODE_SIMPLE, policy.passwordMode);
        assertEquals(5, policy.passwordMaxFails);
    }
}
