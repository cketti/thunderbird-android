...
public abstract class EasOperation {
    ...
    private int performOperationInternal() throws MessagingException {
        ...
        do {
            ...
            try {
                ...
                if (result == RESULT_PROVISIONING_ERROR || response.isProvisionError()) {
                    ...
                    int provisionResult = handleProvisionError();
                    if (provisionResult >= RESULT_MIN_OK_RESULT) {
    ...
    private boolean setProtocolVersionFromServer() throws MessagingException {
...
//    }
    ...
    protected abstract int handleResponse(final EasResponse response)
            throws IOException, CommandStatusException, MessagingException;
     ...
     * @return
     */
    protected int handleProvisionError() throws MessagingException {
