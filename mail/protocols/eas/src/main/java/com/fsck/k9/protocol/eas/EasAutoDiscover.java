...
public class EasAutoDiscover extends EasOperation {
    ...
    private static Account makeAccount(final String username, final String password, final String deviceId) {
