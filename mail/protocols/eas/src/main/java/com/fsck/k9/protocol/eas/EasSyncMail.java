...
import com.fsck.k9.protocol.eas.adapter.AbstractSyncParser;
import com.fsck.k9.protocol.eas.adapter.EmailSyncParser;
...
public class EasSyncMail extends EasSyncCollectionTypeBase {
    ...
    public EasSyncMail(EmailSyncCallback callback, MessageBuilderFactory messageBuilderFactory) {
    ...
    public EasSyncMail(EmailSyncCallback callback, MessageBuilderFactory messageBuilderFactory,
            List<String> messageServerIdsToDelete) {
        this.callback = callback;
        this.messageBuilderFactory = messageBuilderFactory;
...
//    }
    ...
    public AbstractSyncParser getParser(final Context context, final Account account,
        ...
        parser = new EmailSyncParser(is, folderServerId, callback, messageBuilderFactory);
        return parser;
    }
