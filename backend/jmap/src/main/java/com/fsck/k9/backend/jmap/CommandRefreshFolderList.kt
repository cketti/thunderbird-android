...
internal class CommandRefreshFolderList(
    ...
    private val Mailbox.type: Folder.FolderType
        get() = when (role) {
            Role.INBOX -> Folder.FolderType.INBOX
            Role.ARCHIVE -> Folder.FolderType.ARCHIVE
            Role.DRAFTS -> Folder.FolderType.DRAFTS
            Role.SENT -> Folder.FolderType.SENT
            Role.TRASH -> Folder.FolderType.TRASH
            Role.JUNK -> Folder.FolderType.SPAM
