...
public class EmailProviderCacheCursor extends CursorWrapper {
    ...
    public EmailProviderCacheCursor(String accountUuid, Cursor cursor, Context context) {
        super(cursor);
        mCache = EmailProviderCache.getInstanceForAccount(accountUuid, context);
    ...
    public int getInt(int columnIndex) {
        ...
        String value = mCache.getValue(messageId, columnName);

        if (value != null) {
            System.out.println("EmailProviderCacheCursor.getInt() - found cached value: " + value);
        ...
        if (value != null) {
            System.out.println("EmailProviderCacheCursor.getInt() - found cached value for thread: " + value);
