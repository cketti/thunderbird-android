...
Log.d("ASH", "Have set delete policy to " + mAccount.getDeletePolicy());
        ...
        // Only set special folders if the user actually selected a value
        String newArchiveFolder = mArchiveFolder.getValue();
        if (newArchiveFolder != null) {
            mAccount.setArchiveFolderName(newArchiveFolder);
        }
        String newDraftsFolder = mDraftsFolder.getValue();
        if (newDraftsFolder != null) {
            mAccount.setDraftsFolderName(newDraftsFolder);
        }
        String newSentFolder = mSentFolder.getValue();
